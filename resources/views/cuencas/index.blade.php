                ...
                <div class="kt-form kt-form--label-right kt-margin-t-20 kt-margin-b-10">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 kt-align-right">
                            @can('create', App\Cuenca::class)
                                <a href="{{ route('cuencas.create')}}" type="button" class="btn btn-success btn-elevate btn-pill">Nueva Cuenca</a>
                            @endcan
                        ...
                        <thead class="kt-datatable__head">
                            <tr class="kt-datatable__row" style="left: 0px;">
                                ...
                                <th data-field="ShipDate" class="kt-datatable__cell kt-datatable__cell--sort">
                                    <span style="width: 117px;">Unidad de gestión de cuencas</span>
                                </th>
                                <th data-field="CompanyName" class="kt-datatable__cell kt-datatable__cell--sort">
                                    <span style="width: 117px;">Nombre de la Cuenca</span>
                                </th>
                            ...
                            @foreach ($cuencas as $cuenca)
                                <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                    <td data-field="OrderID" class="kt-datatable__cell">
                                        <span style="width: 117px;">{{ $cuenca->codigo}}</span>
                                    </td>
                                    <td data-field="Country" class="kt-datatable__cell">
                                        <span style="width: 117px;">{{ $cuenca->unidadGestionCuenca->codigo}} - {{ $cuenca->unidadGestionCuenca->nombre}}</span>
                                    </td>
                                    <td data-field="ShipDate" class="kt-datatable__cell">
                                        <span style="width: 117px;">{{ $cuenca->nombre}}</span>
                                    </td>
                                    <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
                                        <span style="overflow: visible; position: relative; width: 110px;">
                                            <a href="{{ route('cuencas.show', $cuenca->id)}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Consultar"><i class="la la-file"></i></a>
                                            @can('update', $cuenca)
                                                <a href="{{ route('cuencas.edit', $cuenca->id)}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Modificar"><i class="la la-edit"></i></a>
                                            @endcan
                                        </span>
                                    </td>
                                </tr>
