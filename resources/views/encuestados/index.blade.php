                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 kt-align-right">
                            @can('create', App\User::class)
                                <a style=" background-color: #5a96e5; border-color: #5a96e5; " href="#" type="button" class="btn btn-success btn-elevate btn-pill">
                        ...
                        <thead class="kt-datatable__head">
                            <tr class="kt-datatable__row" style="left: 0px;">
                                <th data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                                    <span style="width: 117px;">Lugar</span>
                                </th>
                                <th data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                            ...
                            @foreach ($encuestados as $encuestado)
                                <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                    <td data-field="OrderID" class="kt-datatable__cell">
                                        <span style="width: 117px; overflow: visible;">Colombia - Pacífico - Comunidad 1</span>
                                    </td>
                                    <td data-field="OrderID" class="kt-datatable__cell">
                                        <span style="width: 117px; overflow: visible;">{{ $encuestado->identificacion}}</span>
                                    </td>
                                    <td data-field="ShipDate" class="kt-datatable__cell">
                                        <span style="width: 117px;">{{ $encuestado->nombre}}</span>
                                    </td>
                                    <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
                                        <span style="overflow: visible; position: relative; width: 110px;">
                                            <a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Consultar"><i class="la la-file"></i></a>
                                            @can('update', $encuestado)
