    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form id="registro" class="kt-form kt-form--label-right" method="POST" action="{{ route('comunidades.store') }}" role="form" enctype='multipart/form-data'>
                    @csrf
                                ...
                                <div class="kt-input-icon kt-input-icon--right">
                                    <select class="form-control" name="cuenca_id" required>
                                        ...
                                        @foreach ($cuencas as $cuenca)
                                            <option value="{{ $cuenca->id }}">{{ $cuenca->codigo }} - {{ $cuenca->nombre }}</option>
                                        @endforeach
                                    </select>
