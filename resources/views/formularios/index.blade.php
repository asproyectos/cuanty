                            ...
                            @foreach ($formularios as $formulario)
                                <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                    <td data-field="OrderID" class="kt-datatable__cell">
                                        <span style="width: 117px;">{{ $formulario->nombre}}</span>
                                    </td>
                                    {{-- <td data-field="Country" class="kt-datatable__cell">
                                        <span style="width: 117px;">{{ $formulario->cuenca->nombre}}</span>
                                    </td> --}}
                                    ...
                                    <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
                                        <span style="overflow: visible; position: relative; width: 110px;">
                                            <a href="{{ route('comunidades.show', $formulario->id)}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Consultar"><i class="la la-file"></i></a>
                                            @can('update', $formulario)
                                                <a href="{{ route('comunidades.edit', $formulario->id)}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Modificar"><i class="la la-edit"></i></a>
                                            @endcan
                                        </span>
                                    </td>
                                </tr>
