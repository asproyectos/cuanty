        ...
        <div class="col-xl-12">
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body" style="flex-direction: initial;">
                    ...
                    <div class="col-md-4">
                        <div class="form-group ">
                            <h5>Verificada por</h5>
                            <p>@if ($ronda->verificada)
                                {{ $ronda->verificadaPor->name}}
                            @else
                                sin verificar
                            @endif</p>
                        </div>
                ...
                <div class="kt-portlet__body" style="flex-direction: initial;">
                    <div class="col-md-4 offset-md-2">
                        <div class="form-group">
                            ...
                            <p>
                                <span style="font-size: 20px;"><i class="fas fa-sticky-note as-sticker-{{$ronda->tipo_comentario_id}}"></i></span>
                                {{ $ronda->comentario ? $ronda->comentario : 'Sin comentario'  }}
                            </p>
                        </div>
                    </div>
                    @if ($ronda->verificada)
                        <div class="col-md-4">
                            <div class="form-group ">
                                <h5>Comentario del Operador de sala de control</h5>
                                <p>
                                    {{ $ronda->comentario_verificacion ? $ronda->comentario_verificacion : 'Sin comentario'  }}
                                </p>
                            </div>
                        </div>
                    @endif
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="accordion accordion-solid accordion-panel accordion-toggle-svg" id="accordionExample8">
                @foreach ($ronda->getGrupoPreguntas(1) as $grupoPregunta)
                    <div class="card">
                                    ...
                                    <div class="col-md-8 col-md-offset-2">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    @foreach ($ronda->getPreguntas($grupoPregunta->id) as $pregunta)
                                                        <tr>
                                                            ...
                                                            @if ($ronda->respuestas->where('pregunta_id',$pregunta->id)->first() != null)
                                                                ...
                                                                @else
                                                                    ...
                                                                    @elseif ($pregunta->tipo_pregunta_id == 3)
                                                                        <td class="{{$ronda->respuestas->where('pregunta_id',$pregunta->id)->first()->alarma ? 'as-alarma-bg' : ''}}">
                                                                            {{ $ronda->respuestas->where('pregunta_id',$pregunta->id)->first()->extra}}
                                                                        </td>
                                                                    @endif
                                                                @endif
                                                            @else
