                    ...
                    <div class="kt-portlet__body" style="flex-direction: inherit;">
                        <div class="col-md-5">
                            <div class="form-group ">
                                ...
                                <div class="kt-input-icon kt-input-icon--right">
                                    <select class="form-control" name="subregion_id" required>
                                        @foreach ($subregiones as $subregion)
                                            <option {{$comunidad->subregion_id == $subregion->id ? 'selected' : ''}} value="{{ $subregion->id }}">{{ $subregion->codigo }} - {{ $subregion->nombre }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group ">
                                <label>codigo</label>
                                <div class="kt-input-icon kt-input-icon--right">
                                    <input type="text" class="form-control" name="codigo" value="{{$comunidad->codigo}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group ">
                                <label>nombre</label>
                                <div class="kt-input-icon kt-input-icon--right">
                                    <input type="text" class="form-control" name="nombre"  value="{{$comunidad->nombre}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
