    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form id="registro" class="kt-form kt-form--label-right" method="POST" action="{{ route('subregiones.store') }}" role="form" enctype='multipart/form-data'>
                    @csrf
