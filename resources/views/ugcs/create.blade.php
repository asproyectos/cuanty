    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            Creación de Unidad de Gestión de Cuencas
                        </h3>
                    </div>
                ...
                <!--begin::Form-->
                <form id="registro" class="kt-form kt-form--label-right" method="POST" action="{{ route('ugcs.store') }}" role="form" enctype='multipart/form-data'>
                    @csrf
