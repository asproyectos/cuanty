...
var FullCalendar = (function (exports) {
    ...
    function mergeProps(propObjs, complexPropsMap) {
        ...
        for (var i = propObjs.length - 1; i >= 0; i--) {
            ...
            for (var name_2 in props) {
                if (!(name_2 in dest)) { // if already assigned by Anterior props or complex props, don't reassign
    ...
    */
    ...
    function invertRanges(ranges, constraintRange) {
        var invertedRanges = [];
        var start = constraintRange.start; // the end of the Anterior range. the start of the new range
        var i;
        var dateRange;
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            for (var _i = 0, _a = subjectConfig.allows; _i < _a.length; _i++) {
                ...
                var eventApi = void 0;
                if (origDef) { // was Anteriorly in the calendar
    ...
    */
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        // from its Anterior value. decremented = -1, incremented = 1 (default).
    ...
    */
    ...
    /*
    BUG: if `event` was supplied, all Anteriorly-given `eventSources` will be wiped out
    */
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype._handleAction = function (action) {
            ...
            var renderableEventStore = (eventSourceLoadingLevel && !currentViewData.options.progressiveEventRendering) ?
                (state.renderableEventStore || eventStore) : // try from Anterior state
                eventStore;
    ...
    */
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handleDragStart = function (ev) {
                _this.component.context.calendarApi.unselect(ev); // unselect Anterior selections
            };
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleDragStart = function (ev) {
                ...
                if (ev.isTouch) {
                    ...
                    // if now using mouse, but was Anterior touch interaction, clear selected event
        ...
        EventDragging.prototype.displayDrag = function (nextContext, state) {
            ...
            // does the Anterior calendar need to be cleared?
    ...
    */
    var InferredElementDragging = /** @class */ (function (_super) {
        ...
        InferredElementDragging.prototype.setMirrorIsVisible = function (bool) {
            if (bool) {
                // restore a Anteriorly hidden element.
                ...
                if (!segIsHidden[seg.eventRange.instance.instanceId]) {
                    ...
                    if (seg.firstCol === seg.lastCol && seg.isStart && seg.isEnd) { // TODO: simpler way? NOT DRY
                        segMarginTops[seg.eventRange.instance.instanceId] =
                            placement.top - currentNonAbsBottom; // from Anterior seg bottom
                        currentAbsHeight = 0;
