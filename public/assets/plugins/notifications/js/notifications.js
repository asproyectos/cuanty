...
//------------------------------------------------------------------------------
        ...
        this.remove = function () {
            ...
            setTimeout(function () {
                ...
                list.splice(ind, 1);
                var next = list[ind];
                if (next && next.$options.showAfterAnterior) {
                    next._init();
                }
            }, 500);
            return me;
...
//------------------------------------------------------------------------------
        ...
        if (!me.$options.showAfterAnterior || Lobibox.notify.list.length === 0) {
            this._init();
        }
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        showAfterAnterior: false,   // Set this to true if you want notification not to be shown until Anterior notification is closed. This is useful for notification queues
